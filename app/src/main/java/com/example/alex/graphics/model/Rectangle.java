...
public class Rectangle implements Drawable, Serializable {
    ...
    public Rectangle(int maxX, int maxY, int color) {
    ...
    public String toString() {
        return p1.getX() + " " + p1.getY() + " " + p2.getX() + " " + p2.getY() + " " + p3.getY() + " " + p3.getY() + " " + p4.getX() + " " + p4.getY() + " " + id + " " + color;
    }
